        ...
        <div className='mt-auto'>
          {userData && (
            <div className='flex items-center space-x-2 mb-4'>
              <div className='h-10 w-10 rounded-full bg-muted flex items-center justify-center overflow-hidden'>{userData.avatar ? <img src={userData.avatar} alt={userData.username} className='h-full w-full object-cover' /> : <UserIcon className='h-6 w-6 text-muted-foreground' />}</div>
              <div>
          ...
          <aside className='w-80 sticky top-14 h-[calc(100vh-3.5rem)] overflow-y-auto p-4 bg-background'>
            ...
            <div className='bg-muted/50 rounded-lg p-4 mb-4'>
              ...
              <div className='space-y-4'>
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <button className='bg-primary text-primary-foreground rounded-full px-3 py-1 text-sm font-medium'>Follow</button>
                </div>
                ...
                <Link href='/explore/users' className='text-primary text-sm hover:underline block text-center mt-2'>
                  Show more
                </Link>
              </div>
            </div>
            ...
            <div className='bg-muted/50 rounded-lg p-4 mb-4'>
              ...
              <div className='space-y-4'>
                ...
                <Link href='/explore/trends' className='text-primary text-sm hover:underline block text-center mt-2'>
                  Show more
                </Link>
              </div>
            </div>
            ...
            <div className='bg-muted/50 rounded-lg p-4'>
              ...
              <div className='space-y-4'>
                ...
                <Link href='/explore/news' className='text-primary text-sm hover:underline block text-center mt-2'>
                  Show more
                </Link>
              </div>
            </div>
