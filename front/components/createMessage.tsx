    ...
    try {
      ...
      const existingConv = Array.isArray(conversations)
          ? conversations.find((conv: Conversation) => {
            ...
            return (
                convIds.length === selectedIds.length &&
                convIds.every((id: string, idx: number) => id === selectedIds[idx])
            );
          })
          : null;
            ...
            <div className='p-4'>
              ...
              <div className='mt-4 max-h-[300px] overflow-y-auto'>
                ...
                {!loading && !error && filteredUsers.length === 0 && (
                    <div className='text-center py-4 text-gray-500'>Vous ne suivez personne pour le moment.</div>
                )}
                {!loading &&
                    !error &&
